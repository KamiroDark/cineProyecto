...
public class HorarioElTiempoQueTenemos extends JPanel {
	 ...
	 * Create the panel.
	 */
	public HorarioElTiempoQueTenemos() {
		setLayout(null);
		...
		btnIniciarSesion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Window win = SwingUtilities.windowForComponent(HorarioElTiempoQueTenemos.this);
				if (win != null) {
		...
		JLabel lblTiempoPoster = new JLabel("");
		lblTiempoPoster.setIcon(
				new ImageIcon(HorarioRobotSalvaje.class.getResource("/co/edu/konradlorenz/view/images/elTiempoQueTenemosPoster.jpg")));
		lblTiempoPoster.setBounds(100, 114, 200, 300);
		add(lblTiempoPoster);

		JLabel lblTextoTiempo = new JLabel("El Tiempo Que Tenemos");
		lblTextoTiempo.setFont(new Font("Impact", Font.PLAIN, 50));
		lblTextoTiempo.setBounds(337, 114, 516, 50);
		add(lblTextoTiempo);
		...
		JLabel lblGenero = new JLabel("Genero: Drama romántico");
		lblGenero.setFont(new Font("Gill Sans MT", Font.BOLD, 17));
		lblGenero.setBounds(100, 448, 273, 24);
		add(lblGenero);

		JLabel lblDuracion = new JLabel("Duracion: 107 min\r\n");
		...
		JLabel lblDescripcion = new JLabel(
				"<html>Es un drama romántico que sigue la relación de Tobías y Almut, explorando el amor y la pérdida a través de fragmentos no lineales de su vida juntos. La película combina elementos de comedia ligera y momentos profundamente emotivos, mientras reflexiona sobre la fugacidad del tiempo y la conexión humana. Destaca por las actuaciones de Florence Pugh y Andrew Garfield, quienes aportan gran química a esta conmovedora historia​.</html>");
		lblDescripcion.setFont(new Font("Arial", Font.BOLD, 15));
		lblDescripcion.setBounds(337, 197, 581, 103);
		add(lblDescripcion);

		Pelicula peliculaTiempo = new Pelicula("El Tiempo Que Tenemos", "12-A", "Drama romántico", 110);
		...
		funciones.add(new Funcion(sala1, "12:00 PM", peliculaTiempo));
		funciones.add(new Funcion(sala1, "3:00 PM", peliculaTiempo));
		funciones.add(new Funcion(sala2, "6:00 PM", peliculaTiempo));
		...
		btnConfirmar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				HorarioElTiempoQueTenemos.this.setVisible(false);
